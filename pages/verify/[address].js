...
export default function Detail({Data, VerifiedData}) {
  ...
  const Verifyf = async () => {
    ...
    //   const transaction = await contract.verifyf();
    
    //   console.log(transaction);
    const re= await contract.verifyf();
    await re.wait();
    ...
    <DetailWrapper>
      <LeftContainer>
        <ImageSection>
          <Image
            ...
            layout="fill"
            src={
              "https://cryptoraiser.infura-ipfs.io/ipfs/" + Data.image
            }
          />
        </ImageSection>
        <Text>
      ...
      <RightContainer>
        ...
        <DonateSection>
          ...
          <Verify onClick={Verifyf}>Verify</Verify>
        </DonateSection>
        <FundsData>
          <Funds>
